...
>```
>%%
>*%%PREFIX%%41 / 9Simple Harmonic Oscillator%%HIGHLIGHT%% ==The force F acting on a mass m, sitting on a springwith stiffness k , can be described in different ways:== %%POSTFIX%%Newton force equals mass by acce*
